...
def train(hyp, opt, device, tb_writer=None):
    ...
    # Freeze
    freeze = [f'model.{x}.' for x in range(opt.freeze)]  # parameter names to freeze (full or partial)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--freeze', type=int, default=0, help='how many layers to freeze')
